...
public final class RatingTest {
    ...
    public void testDoPost() throws IOException {
        ...
        // Note to add date to the timerange constructor once date has been merged
        TutorSession tutoringSessionFake = new TutorSession("elian@google.com", "sfalberg@google.com", null, null, TimeRange.fromStartToEnd(540, 600));
