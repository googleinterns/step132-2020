...
public final class GoalTest {
    ...
    @Test
    public void testDoGetWithNoGoals() throws Exception {
        ...
        // No goals should have been returned
        Assert.assertTrue(stringWriter.toString().contains(expected));
    }

    @Test
    public void testDoGetWithGoals() throws Exception {
        HttpServletRequest request = mock(HttpServletRequest.class);       
        HttpServletResponse response = mock(HttpServletResponse.class);
        ...
        String expected = new Gson()
                            .toJson(new ArrayList<Goal> (Arrays.asList(new Goal("123", "testing", 1))));
    ...
    public void testDoGetWithError() throws Exception {
        ...
        String expected = "{\"error\": \"There was an error getting goals.\"}";
    ...
    public void testDoPost() throws Exception {
        ...
        // New goal should have been added
        Assert.assertTrue(stringWriter.toString().contains(expected));
    }
